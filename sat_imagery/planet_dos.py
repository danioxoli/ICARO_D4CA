...
#
# Project:  ICARO - D4CA
# Purpose:  MERGE multiple tiles and perform ToA and DOS correction on PlanetScope Imagery (https://www.planet.com/docs/spec-sheets/sat-imagery)
...
# (e.g. months of a year) you need to organize Planet imagery files in a folder tree like this one:
#  
#                       (Root Folder) 
#                           |
...
# if you are working under Windows you may chnge the path to the temporary folder from "/tmp" to "%USERPROFILE%\AppData\Local\"
